...
const siteSchema = new mongoose.Schema(
  {
    ...
    spiritualSignificance: {
      type: String,
      maxlength: [1000, "Spiritual significance cannot exceed 1000 characters"],
    },
    pilgrimageInfo: {
      bestTime: String,
      rituals: [String],
...
// Index for siteType and sacredType
siteSchema.index({ siteType: 1 });
siteSchema.index({ sacredType: 1 });
